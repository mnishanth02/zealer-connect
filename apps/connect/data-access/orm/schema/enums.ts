...
export const accountTypeEnum = pgEnum("account_type", ["email", "google", "strava"]);
...
export const privacyEnum = pgEnum("privacy", ["public", "private_by_invite", "discoverable_by_search"]);
export const contentTypeEnum = pgEnum("content_type", ["article", "blog_post", "arena_post"]);
...
export const productCategoryEnum = pgEnum("product_category", ["gear", "training_plan", "other"]);
...
export const mentorshipStatusEnum = pgEnum("mentorship_status", ["pending", "accepted", "active", "inactive"]);
